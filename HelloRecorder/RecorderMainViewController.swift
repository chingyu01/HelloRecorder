//
//  RecorderMainViewController.swift
//  HelloRecorder
//
...
class RecorderMainViewController: UIViewController{
    ...
    @objc func updateAudioMeter(_ timer: Timer) {
        ...
        if let recorder = self.recorder {
            if recorder.isRecording {
                ...
                let resultTime = String(format: "%02d:%02d", min, sec)
               showTimeLabel.text = resultTime
...
//    }
    ...
    func askForNotifications() {
        ...
        NotificationCenter.default.addObserver(self,selector: #selector(RecorderMainViewController.background(_:)),
                                               name: NSNotification.Name.UIApplicationWillResignActive,
                                               object: nil)
        
        NotificationCenter.default.addObserver(self,selector: #selector(RecorderMainViewController.foreground(_:)),
        name: NSNotification.Name.UIApplicationWillEnterForeground,object: nil)
        
        NotificationCenter.default.addObserver(self,selector:#selector(RecorderMainViewController.routeChange(_:)),name: NSNotification.Name.AVAudioSessionRouteChange,object: nil)
    }
